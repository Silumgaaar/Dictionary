...
public class DictionaryRestController {
    ...
    @GetMapping(value = "/user/{idDictionary}")
    ...
    @GetMapping(value = "/user/{idDictionary}/word")
    ...
    @PutMapping(value = "/user/{idDictionary}/word")
    ...
    @PostMapping(value = "/admin/{idDictionary}/word")
    ...
    @DeleteMapping(value = "/admin/{idDictionary}/word")
